...
local function CreateColorPicker(parent, callback, mainFrame)
    ...
    CPFrame.BackgroundColor3 = Color3.fromRGB(25, 25, 25); CPFrame.ZIndex = 2000; CPFrame.Parent = mainFrame
    ...
    Wheel.Image = "rbxassetid://7393858225"; Wheel.BackgroundTransparency = 1; Wheel.ZIndex = 2001; Wheel.Parent = CPFrame
    local Picker = Instance.new("Frame")
    Picker.Size = UDim2.new(0, 10, 0, 10); Picker.ZIndex = 2002; Picker.BackgroundColor3 = Color3.new(1,1,1); Picker.Parent = Wheel; Instance.new("UICorner", Picker).CornerRadius = UDim.new(1,0)
    local drag = false
    ...
    Close.Size = UDim2.new(1, -20, 0, 30); Close.Position = UDim2.new(0, 10, 1, -35); Close.Text = "Fertig"; Close.ZIndex = 2001; Close.Parent = CPFrame; Instance.new("UICorner", Close)
...
function Cinox.Init(manifest)
    ...
    local TitleBar = Instance.new("Frame"); TitleBar.Name = "TitleBar"; TitleBar.Size = UDim2.new(1, 0, 0, 35); TitleBar.BackgroundColor3 = Color3.fromRGB(20, 20, 20); TitleBar.ZIndex = 100; TitleBar.Parent = MainFrame; Instance.new("UICorner", TitleBar); CreateDrag(TitleBar, MainFrame)
    local CloseBtn = Instance.new("TextButton"); CloseBtn.Text = "X"; CloseBtn.Size = UDim2.new(0, 25, 0, 25); CloseBtn.Position = UDim2.new(1, -30, 0, 5); CloseBtn.BackgroundColor3 = Color3.fromRGB(200, 50, 50); CloseBtn.ZIndex = 101; CloseBtn.Parent = TitleBar; Instance.new("UICorner", CloseBtn)
    local MinBtn = Instance.new("TextButton"); MinBtn.Text = "-"; MinBtn.Size = UDim2.new(0, 25, 0, 25); MinBtn.Position = UDim2.new(1, -60, 0, 5); MinBtn.BackgroundColor3 = Color3.fromRGB(60, 60, 60); MinBtn.ZIndex = 101; MinBtn.Parent = TitleBar; Instance.new("UICorner", MinBtn)
    
    local TabContainer = Instance.new("ScrollingFrame")
    TabContainer.Name = "TabContainer"; TabContainer.Size = UDim2.new(0, 120, 1, -45); TabContainer.Position = UDim2.new(0, 5, 0, 40); TabContainer.BackgroundTransparency = 1; TabContainer.ScrollBarThickness = 0; TabContainer.ZIndex = 50; TabContainer.Parent = MainFrame
    ...
    function Lib:AddTab(conf)
        local TabBtn = Instance.new("TextButton"); TabBtn.Size = UDim2.new(1, 0, 0, 30); TabBtn.Text = conf.Name; TabBtn.ZIndex = 60; TabBtn.Parent = TabContainer; Instance.new("UICorner", TabBtn)
        local Page = Instance.new("ScrollingFrame")
        Page.Name = conf.Name; Page.Size = UDim2.new(1, 0, 1, 0); Page.BackgroundTransparency = 1; Page.Visible = false; Page.ScrollBarThickness = 2; Page.AutomaticCanvasSize = "Y"; Page.ZIndex = 11; Page.Parent = PageContainer
        ...
        function TabObj:AddTool(t)
            ...
            b.Size = UDim2.new(0, 410, 0, 40); b.Text = "  " .. t.Name; b.BackgroundColor3 = Color3.fromRGB(45, 45, 45); b.TextColor3 = Color3.new(1, 1, 1); b.TextXAlignment = "Left"; b.ZIndex = 12; b.Parent = Page; Instance.new("UICorner", b)
