...
local function CreateColorPicker(parent, callback, isMobile)
	...
	if isMobile then
		...
		CPFrame.Position = UDim2.new(0.5, -110, 0.5, -130)
	else
		CPFrame.Size = UDim2.new(0, 170, 0, 170)
		CPFrame.Position = UDim2.new(1, 10, 0, 0)
	end
	CPFrame.BackgroundColor3 = Color3.fromRGB(25, 25, 25); CPFrame.ZIndex = 200; CPFrame.Active = true; CPFrame.Parent = isMobile and parent.Parent.Parent.Parent.Parent or parent
	Instance.new("UICorner", CPFrame); local stroke = Instance.new("UIStroke", CPFrame); stroke.Color = Color3.fromRGB(100, 100, 100); stroke.Thickness = 1.5
	local Wheel = Instance.new("ImageButton")
	Wheel.Size = UDim2.new(0, 140, 0, 140); Wheel.Position = UDim2.new(0.5, -70, 0, 10); Wheel.Image = "rbxassetid://4155801252"; Wheel.BackgroundTransparency = 1; Wheel.ZIndex = 201; Wheel.Parent = CPFrame
	local Picker = Instance.new("Frame")
	Picker.Size = UDim2.new(0, 12, 0, 12); Picker.BackgroundColor3 = Color3.new(1,1,1); Picker.ZIndex = 202; Picker.Position = UDim2.new(0.5, -6, 0.5, -6); Picker.Parent = Wheel
	Instance.new("UICorner", Picker).CornerRadius = UDim.new(1,0); local pStroke = Instance.new("UIStroke", Picker); pStroke.Thickness = 2; pStroke.Color = Color3.new(0,0,0)
	local CloseBtn = Instance.new("TextButton")
	CloseBtn.Size = UDim2.new(1, -20, 0, 35); CloseBtn.Position = UDim2.new(0, 10, 1, -45); CloseBtn.Text = "Auswählen"; CloseBtn.Font = Enum.Font.GothamBold; CloseBtn.BackgroundColor3 = Color3.fromRGB(40, 180, 40); CloseBtn.TextColor3 = Color3.new(1,1,1); CloseBtn.ZIndex = 201; CloseBtn.Visible = isMobile; CloseBtn.Parent = CPFrame
...
function Cinox.Init(manifest)
	...
	function Lib:AddTab(conf)
		...
		local Page = Instance.new("ScrollingFrame"); Page.Name = conf.Name; Page.Size = UDim2.new(1, 0, 1, 0); Page.BackgroundTransparency = 1; Page.Visible = false; Page.Parent = PageContainer; Page.ScrollBarThickness = 2; Page.AutomaticCanvasSize = "Y"
